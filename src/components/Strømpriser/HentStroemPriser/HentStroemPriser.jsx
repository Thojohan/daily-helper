...
import Selector from "../../SelectorCheckboxes/Selector.jsx";
import styles from "./HentStroemPriser.module.css";
import LineChart from "../../Chart/LineChart.jsx";
import Loading from "../../Status/LoadingMessage/Loading.jsx";
import ErrorMessage from "../../Status/ErrorMessage/ErrorMessage.jsx";
      ...
      async function finnStroem() {
        try {
          const data = await fetch(
            `${
              import.meta.env.VITE_HVAKOSTERSTROMMEN_URL
            }/api/v1/prices/${year}/${month}-${date}_${area.at(1)}.json`
          );
